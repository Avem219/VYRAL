...
export default function FeedPage() {
  ...
  return (
    <div className="max-w-[860px] mx-auto px-3 sm:px-5 py-5 sm:py-8">
      <div className="flex items-end justify-between mb-5">
        <div><p className="eyebrow">Home / Signal</p><h1 className="text-2xl font-semibold tracking-tight mt-1">Your world</h1></div>
        <Link href="/create" className="vy-btn-secondary text-xs">Create</Link>
      </div>

      <div className="vy-glass vy-chamfer p-4 mb-6 vy-scanline">
        <textarea
          value={composerText}
      ...
      {items === null ? (
        ...
        <ul className="space-y-4">
          {items.map((item) => (
            <li key={item.id} className="vy-glass vy-chamfer p-4">
